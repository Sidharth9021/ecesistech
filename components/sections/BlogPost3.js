                ...
                <div className="container">
                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-4 col-md-6">
                            <div className="blog__post-two">
                                <div className="blog__post-thumb-two">
                                    <Link href="#"><img src="/assets/img/blog/h2_blog_post01.jpg" alt="" /></Link>
                                </div>
                                <div className="blog__post-content-two">
                                    <div className="blog-post-meta">
                                        <ul className="list-wrap">
                                            <li>
                                                <Link href="#" className="blog__post-tag-two">Business</Link>
                                            </li>
                                            <li><i className="fas fa-calendar-alt" />Oct 21, 2024</li>
                                        </ul>
                                    </div>
                                    <h2 className="title"><Link href="#">Marketing your area business downturn now a days</Link></h2>
                                    <div className="blog-avatar">
                                        <div className="avatar-thumb">
                                            <img src="/assets/img/blog/blog_avatar01.png" alt="" />
                                        </div>
                                        <div className="avatar-content">
                                            <p>By <Link href="#">Doman Smith</Link></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="blog__post-two">
                                <div className="blog__post-thumb-two">
                                    <Link href="#"><img src="/assets/img/blog/h2_blog_post02.jpg" alt="" /></Link>
                                </div>
                                <div className="blog__post-content-two">
                                    <div className="blog-post-meta">
                                        <ul className="list-wrap">
                                            <li>
                                                <Link href="#" className="blog__post-tag-two">Audit</Link>
                                            </li>
                                            <li><i className="fas fa-calendar-alt" />Oct 21, 2024</li>
                                        </ul>
                                    </div>
                                    <h2 className="title"><Link href="#">Improving The Double Diamond Design Process</Link></h2>
                                    <div className="blog-avatar">
                                        <div className="avatar-thumb">
                                            <img src="/assets/img/blog/blog_avatar01.png" alt="" />
                                        </div>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="blog__post-two">
                                <div className="blog__post-thumb-two">
                                    <Link href="#"><img src="/assets/img/blog/h2_blog_post03.jpg" alt="" /></Link>
                                </div>
                                <div className="blog__post-content-two">
                                    <div className="blog-post-meta">
                                        <ul className="list-wrap">
                                            <li>
                                                <Link href="#" className="blog__post-tag-two">Investment</Link>
                                            </li>
                                            <li><i className="fas fa-calendar-alt" />Oct 21, 2024</li>
                                        </ul>
                                    </div>
                                    <h2 className="title"><Link href="#">Revealing Images With CSS Mask Animations</Link></h2>
                                    <div className="blog-avatar">
                                        <div className="avatar-thumb">
                                            <img src="/assets/img/blog/blog_avatar01.png" alt="" />
                                        </div>
