...
export default function Services5() {
    return (
        <>
            <section className="services__area-seven services__bg-seven bg-lblue" data-background="/assets/img/bg/h3_services_bg.jpg">
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-lg-7">
                            <div className="section-title text-center mb-50 tg-heading-subheading animation-style3">
                                <span className="sub-title">WHAT WE OFFER</span>
                                <h2 className="title tg-element-title text-white">We Do World Class Work For You</h2>
                                <p className="tg-element-title text-white mb-5">Mauris ut enim sit amet lacus ornare ullamcorper Praesent plaacerat <br /> neque eu purus rhoncus vel tincidunt odio ultrices.</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="col-xl-2 col-lg-2 col-md-6">
                                <Link href="#">
                                    <div className="services__item-five px-4 py-5">
                                        ...
                                        <h2 className="text-lg">Broker Price Opinion</h2>
                                        {/* <div className="project__nav-wrap">
                                            <div className="project-next bottom-0 bg-lyellow" style={{left: "20.5%", top: "82%"}}><i className="flaticon-right-arrow" /></div>
                                        </div> */}
                            ...
                            <div className="col-xl-2 col-lg-2 col-md-6">
                                <Link href="#">
                                    <div className="services__item-five px-4 py-5">
                                        ...
                                        <h2 className="text-lg">Accounting & Tax</h2>
                                        {/* <div className="project__nav-wrap">
                                            <div className="project-next bottom-0 bg-lyellow" style={{left: "34.3%", top: "82%"}}><i className="flaticon-right-arrow" /></div>
                                        </div> */}
                                        {/* <div className="services__content-five hidden">
                            ...
                            <div className="col-xl-2 col-lg-2 col-md-6">
                                <Link href="#">
                                    <div className="services__item-five px-4 py-5">
                                        ...
                                        {/* <div className="project__nav-wrap">
                                            <div className="project-next bottom-0 bg-lyellow" style={{left: "48%", top: "82%"}}><i className="flaticon-right-arrow" /></div>
                                        </div> */}
                                        {/* <div className="services__content-five hidden">
                            ...
                            <div className="col-xl-2 col-lg-2 col-md-6">
                                <Link href="#">
                                    <div className="services__item-five px-4 py-5">
                                        ...
                                        <h2 className="text-lg">Manpower Staffing</h2>
                                        {/* <div className="project__nav-wrap">
                                            <div className="project-next bottom-0 bg-lyellow" style={{right: "34.3%", top: "82%"}}><i className="flaticon-right-arrow" /></div>
                                        </div> */}
                                        {/* <div className="services__content-five hidden">
                            ...
                            <div className="col-xl-2 col-lg-2 col-md-6">
                                <Link href="#">
                                    <div className="services__item-five px-4 py-5">
                                        ...
                                        <h2 className="text-lg">Digital Marketing</h2>
                                        {/* <div className="project__nav-wrap">
                                            <div className="project-next bottom-0 bg-lyellow" style={{right: "20%", top: "82%"}}><i className="flaticon-right-arrow" /></div>
                                        </div> */}
                                        {/* <div className="services__content-five hidden">
