...
export default function Marquee2() {
    return (
        <div className="marquee__area-two">
            <Marquee className="marquee__wrap max-h-24 overflow-hidden" gradient={false} speed={100}>
                <img src="/assets/img/brand/Papa John.png" className="w-32 h-24 object-contain mr-16" alt="Papa John" />
                <img src="/assets/img/brand/Claruz.png" className="w-32 h-24 object-contain mr-16" alt="Claruz" />
                ...
                <img src="/assets/img/brand/EDST.png" className="w-60 h-24 object-contain mr-16" alt="EDST" />
                ...
                <img src="/assets/img/brand/UAQ.png" className="w-24 h-20 object-contain mr-16" alt="UAQ" />
            </Marquee>
        </div>
    );
}
