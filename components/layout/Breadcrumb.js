    ...
    return (
        <>
            <section className={`breadcrumb__area breadcrumb__bg_real_estate`}>
                ...
                <img src={matchingBanner.backgroundImageUrl ? matchingBanner.backgroundImageUrl : "/assets/img/bg/breadcrumb_bg.jpg"} alt="" className={`absolute ${matchingBanner.img_style} ${isMobile ? "h-full" : "object-fill"}  w-full -z-1 top-0 `} />
